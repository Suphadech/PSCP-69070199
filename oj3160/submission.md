...
```text
เขียนโปรแกรมหาจํานวนเฉพาะในช่วงที่ต้องการ
Input:
...
Step2:รับค่า Input เป็นช่วงโดยมีค่าเริ่มต้นและค่าสุดท้าย
Step3:สร้างตัวแปร prime_list เอาไว้เก็บค่าจำนวนเฉพาะลงใน list 
Step4:ใช้ for-loop โดย loop แรกจะเป็น ค่าของตัวเลขที่อยู่ในช่วงนั้นแล้วใช้ loop ครั้งที่สองเพื่อเอาไว้เช็คว่าค่านั้นเป็นจำนวนเฉพาะหรือไม่ตามนิยามของจำนวนเฉพาะ
Step5:ใช้ if-else ในการเช็คเงื่อนไขว่าใช่ prime หรือไม่หลังเช็คก็เอา prime ที่เช็คได้ใส่เข้าไปใน list ที่สร้างไว้
Step6:ปริ้น list ของ prime number  พร้อมกับบอกว่ามีกี่ตัวด้วยฟังก์ชัน len
```
...
```text
วิธีสุดท้ายของผมคล้ายกับแผนแรก แต่เนื่องจากที่ส่งไปแล้วติดแดงใน i judge ก็นั่งคิดกรณีเพิ่มหลายอย่างจนทำผ่านและกรณีนั้นคือหากไม่มีค่า prime ก็ต้องใช้ if เช็คว่ามี prime ใน list ไหมหากมีก็ให้ปริ้น prime ใน list ออกมา
```
