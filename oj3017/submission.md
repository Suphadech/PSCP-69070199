...
```text
โจทย์รับค่า input เป็นจำนวนเต็มและนำไปคำนวณผลรวมที่ลูกค้าต้องชำระเงินหลังจากได้รวมค่าบริการและ VAT

Input : จำนวนเงินรวมเฉพาะค่าอาหารและเครื่องดื่ม (จำนวนเต็ม)

Output : ผลรวมที่ลูกค้าต้องชำระจากค่าบริการและ VAT 7% (แสดงเป็นจำนวนจริงทศนิยม 2 หลัก)
```
...
Step 2: รับค่า input เป็นจำนวนเต็มเก็บไว้ในตัวแปร cash
Step 3: สร้างตัวแปร service เก็บค่าให้บริการโดยการเอา cash ไปหาร / 10
step 4 : เนื่องจากมีข้อกำหนดว่าค่าบริการจะคิดอย่างน้อย 50 บาท แต่จะไม่เกิน 1000 บาทด้วยเลยต้องใช้ if-elif ในการเช็คหากค่าบริการมีน้อยกว่า 50 ดังนั้นservice = 50 เพราะเป็นอย่างนั้อยและเมื่อเกิน 1000 ก็ให้ service = 1000 เพราะไม่สามารถเกิน 1000 ได้
step 5 : สร้างตัวแปร vat จากการนำค่าบริการและค่าอาหารรวมกัน คูณด้วย 7% ก็จะได้ค่า vat
step 6 : สร้างตัวแปร total และนำค่าอาหาร,บริการ,vat มาบวกกัน
step 7 : print total โดยใช้ F-string แสดงทศนิยม 2 ตำแหน่ง
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ใช้ if-elif ตรวจเงื่อนไขแล้วคิดกระบวนการทางคณิตศาสตร์ก็จะได้ผลลัพธ์ออกมาพร้อมกับลอง testcase อื่นๆด้วย
```
...
```text
ทดสอบว่าการคำนวณนั้นถูกต้องและตรงกับ Output ที่ได้
```
