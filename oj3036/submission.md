...
```text
โจทย์ให้หาวิธีในการเดินทางไปยังห้องที่ 1 ที่สั้นที่สุดจากปราสาทที่สร้างแบบปีระมิดโดยแต่ละชั้นจะมีห้องเท่ากับจำนวนกำลังสองของชั้นนั้นๆโดยแต่ละชั้นจะมีสามเหลี่ยมขึ้นบนและสามเหลี่ยมลงล่างโดยวิธีที่จะผ่านแต่ละห้องไปก็ต้องพังกำแพงผ่านไปทีละห้อง

Input : ระบุจำนวนเต็มค่า N (1 <= N <= 100,000) เป็นห้องที่เราอยู่ ณ ตอนนี้

Output : ระบุจำนวนกำแพงน้อยที่สุดที่จะต้องพัง เพื่อเดินทางจากห้อง N ไปจนถึงห้องหมายเลข 1 ถ้าไม่ต้องพังกำแพงเลยก็ตอบ 0
```
...
Step 2: นั่งดูความสัมพันธ์ในการ Generate ของปราสาทรูปแบบปิรามิดสรุปได้ว่าห้องเท่ากับจำนวนกำลังสองของชั้นนั้นๆโดยแต่ละชั้นจะมีสามเหลี่ยมขึ้นบนและสามเหลี่ยมลงล่างหากเราอยู่ห้องที่เป็นรูปสามเหลี่ยมขึ้นบนเราจะต้องพังแพงมากกว่าห้องที่เป็นรูปสามเหลี่ยมล่าง 1 ห้องโดยในแถวที่เป็นเลขคี่ เลขคี่ทุกตัวที่อยู่ในแถวจะเป็นรูปสามเหลี่ยมขึ้นบนที่เหลือลงล่างแล้วในแถวเลขคู่เลขคู่ทุกตัวที่อยู่ในแถวจะเป็นรูปสามเหลี่ยมขึ้นบนที่เหลือลงล่างเช่นกัน
Step 3: หาความสัมพันธ์หากเราอยู่ในห้องสามเหลี่ยมขึ้นบนเราจะได้วิธีที่จะขึ้นได้เร็วที่สุดเป็น 2*(แถว-1) ส่วนห้องสามเหลี่ยมลงล่างจะได้เป็น (2*(แถว-1)) -1
Step 4: ทำการ import math เพื่อจะได้เรียกใช้ฟังก์ชันต่างๆของคณิต
Step 5: สร้างตัวแปร num เป็นจำนวนเต็ม(ห้องที่เราอยู่)
Step 6: หาแถวโดยการใช้ฟังก์ชัน math จากการ เอาเลขห้องไปใส่รูทแล้วปัดเศษขึ้นด้วย .ceil ก็จะได้แถวมา
Step 7: เขียนเงื่อนไขตามที่ผมเข้าใจจาก step 2
Step 8: ดูOutput
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมใช้ if-elif ตรวจสอบเงื่อนไขที่ผมต้องการแล้วก็รันพร้อมกับลอง testcase อื่นๆ
```
...
```text
ทดสอบต้องการให้ Output ตรงกับที่โจทย์กำหนด
```
