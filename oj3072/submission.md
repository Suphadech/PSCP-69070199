...
```text
เขียนโปรแกรม นับสระ ที่อยู่ในข้อความ โดย เก็บลงใน Array นับเพียงแค่ a e i o u
...
Step2:รับค่า Input text
Step3:ใช้ if หาก มีสระอยู่ให้ text แล้วใช้ฟังก์ชั่น count นับ
Step4:ปริ้นดูผลลลัพธ์
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรกใช้ if หาก มีสระอยู่ให้ text แล้วใช้ฟังก์ชั่น count นับ
```
...
```text
ดูว่าเป็นไปตามที่เราคิดหรือเปล่า
```
