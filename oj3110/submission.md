...
```text
รับค่า input เป็นสถานีต้นทางกับสถานีปลายทางและน้ำหนักพัสดุแล้วเอามาคำนวณตาทเงื่อนไขโจทย์
...
Output:
ผลราคาของการจัดส่งหากเส้นทางไม่อยู่ตามที่โจทย์กำหนดให้ print(“Error”)
```
...
Step2:รับค่า input สถานีต้นทางปลายทางและน้ำหนักพัสดุ
Step3:เขียน if-else ตามเงื่อนไขที่โจทย์บอกพร้อมคำนวณราคาหากไม่เข้าเงื่อนไขให้ print Error
Step4:สั่งปริ้น output ออกมาแล้ว checkว่าตรงกับที่เราคิดไหม
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมรับค่า input แล้วเอาไปเช็คเงื่อนไข if else แล้วสั่ง print output ที่ถูกต้ิงออกมา 
```
...
```text
ทดสอบตาม sample testcase ของ i judge
```
