...
```text
มีจํานวนนับ x ในช่วง [A , B] กี่จํานวน ที่หารด้วยจํานวนนับ d แล้วเหลือเศษ r
Input :
จํานวนนับ A 
จํานวนนับ B  (โดยที่ B > A)
จํานวนนับ d (ตัวหาร) 
จํานวนนับ r (เศษ)  (โดยที่ r < d)

Output:
 จํานวนข้อมูลที่สอดคล้อง
```
...
```text
Step1:เขียนModuleDocstringกัน pep-8
Step2:รับค่าinputตามที่โจทย์กำหนด
Step3:ใช้ for-loop check ค่าใน [A,B] ที่หารด้วย d แล้วเหลือเศษ r ถ้าจริงก็ +1
Step4:แสดงผลOutput
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมใช้:ใช้ for-loop check ค่าใน [A,B] ที่หารด้วย d แล้วเหลือเศษ r ถ้าจริงก็ +1
แล้วปริ้นดูผลลัพธ์
```
...
```text
Check sample testcase ใน i judge
```
