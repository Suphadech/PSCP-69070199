...
```text
โจทย์ให้รับค่าจำนวนเต็มบวก 1 จำนวนจากนั้นหาว่าจำนวนเต็มบวกตั้งแต่ N ถึง 0 มีตัวเลขใดบ้างที่หารด้วย 10 ลงตัว และให้แสดงตัวเลขเหล่านั้นทางหน้าจอ

Input : จำนวนเต็มบวก

Output : แสดงจำนวนเต็มบวกตั้งแตจำนวนที่ Input มาถึง 0 ที่หารด้วย 10 ลงตัว
```
...
Step 2: สร้างตัวแปร num รับค่าจำนวนเต็มบวก
Step 3: ใช้ for loop ในการลดค่า จำนวนเต็มทีละ 1 สิ้นสุดที่ 0
Step 4: เขียนเงื่อนไขลงไปในลูปว่าหาก เจอจำนวนทีหาร 10 ได้ลงตัวก็ให้ทำการปริ้นและให้คำสั่ง end = " "เพื่อไม่ให้outputขึ้นบรรทัดใหม่เมื่อมีตัวที่หาร 10 ลงตัวอีกตัว
step 5:ดูผลลัพธ์
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมใช้ for loop ในการลดค่าของ num  ทีละหนึ่งแล้วก็สั่งให้ปริ้นเมื่อเจอจำนวนที่หารด้วย 10 ลงตัวและใช้ end = " " เพื่อไม่ให้ output ขึ้นบรรทัดใหม่
```
...
```text
เพื่อนคู่ pair programming (ต้นหนาว)
```

เขาช่วยอะไร

```text
ช่วยคิดเรื่องการแสดงผล Output ให้ไม่ต้องขึ้นบรรทัดใหม่ด้วยคำสั่ง end = " "
```

คุณยังทำอะไรด้วยตนเอง

```text
เรื่อง for loop และช่วยกันทำกับเพื่อนคู่ pair ครับ
```
