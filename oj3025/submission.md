...
```text
โจทย์ให้เขียนโปรแกรมแสดงฤดูกาล สําหรับเดือนและวันที่กําหนด โดยที่ตั้งแต่วันที่ 21 ของเดือนที่ 3 หารลงตัวจะเปลี่ยนฤดูโดยที่
เดือน 1, 2, 3 เป็น (winter)
เดือน 4, 5, 6 เป็น (spring)
เดือนที่ 7, 8, 9 เป็น (summer)
เดือน 10, 11, 12 เป็น(fall)

Input : เดือน (จำนวนเต็ม) กับ วันที่ (จำนวนเต็ม)

Output : แสดงผลฤดูกาลในวันที่ของเดือนนั้น
```
...
Step 2: รับ input สองค่าคือ เดือนและวันที่เก็บในตัวแปร mon,day ตามลำดับ
Step 3: ใช้ if เช็กเงื่อนไข หาก เดือนตรงกับ 1,2,3 แล้วเช็กเงื่อนไขต่อหาก เดือนตรงกับ 3 แล้วก็เช็กต่อว่าหากวันที่นั้นมากกว่าหรือเท่า 21 ฤดูกาลก็จะเปลี่ยนเป็น spring ส่วนที่เหลือก็ winter
Step 4 :ทำแบบเดียวกันกับ Step3 แต่เปลี่ยนเดือนและฤดูกาลตามที่โจทย์กำหนดให้
Step 5:ดูผลลัพธ์
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมใช้ if-else-elif ในการเช็กเงื่อนไขตามที่โจทย์กำหนดและนำเอาไป test ในหลายๆ testcase เพื่อดู output
```
...
```text
ทดสอบเพื่อให้ถูกตามoutputที่ต้องการ
```
...
```text
คู่ pair programming (เก้า)
```

เขาช่วยอะไร

```text
ช่วยดูเงื่อนไขในโจทย์(ช่วยๆกันทำ)
```
