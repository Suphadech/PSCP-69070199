...
```text
โจทย์ให้รับค่า จำนวนจริงแล้วให้ทำการกำหนดหน่วยอุณหภูมิจากจำนวนจริงนั้นแล้วเปลี่ยนหน่วยอุณหภูมิจากหน่วยหนึ่งไปอีกหน่วยหนึ่งแล้วแสดงผลลัพธ์

Input : ตัวแปรเอาไว้เก็บค่าจำนวนจริง กับ หน่วยที่โจทย์กำหนด และ หน่วยที่ต้องการให้เป็น

Output : จำนวนจริง เป็นอุณหภูมิ ตามหน่วยในบรรทัดที่ต้องการ ใน Input (ทศนิยม 2 ตำแหน่ง)
```
...
Step 2: สร้างตัวแปร temp รับค่าจำนวนจริง สร้างตัวแปร unit_1 เป็นหน่วยของจำนวนจริงนั้นและสร้างอีกตัวแปร unit_2 เอาไว้เก็บค่าหน่วยที่ต้องการ
step 3 : สร้างตัวแปร celsius = 0 เอาไว้เพื่อที่จะเอาไปใช้เปลี่ยนเป็นหน่วยCที่ทำให้คิดง่ายขึ้น
Step 4: ใช้ if-elif ตรวจสอบเงื่อนไขหาก unit_1 เท่ากับ C จะให้ celsius = จำนวนจริงนั้นและถ้า unit_1 เป็นหน่วยอุณหภูมิอื่นๆก็เอาไปทำตามกระบวนการคณิตศาสตร์แล้วให้ผลลัพธ์ เท่ากับตัวแปร celsius
Step 5: ใช้ if-elif ตรวจสอบเงื่อนไขว่า unit_2 เป็นหน่วยอะไรที่อยากให้เอาไปแปลงแล้วก็เอาตัวแปร celsius มาคำนวณในเงื่อนไขที่ตองการพร้อม print ใรรูปแบบ F-string ทศนิยมสองตำแน่ง
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมใช้ if-elif ในการตรวจสอบเงื่อนไขแล้วทำการแปลงหน่วยแรกให้เป็นหน่วย celsius ก่อนเพื่อความง่ายในการคำนวณหน่วยที่ต้องการแล้วก็ลองหลายๆ testcase ที่สอดคล้องกับโจทย์
```
...
```text
ทอสอบเพื่อให้ Output ตรงกับ testcase ตัวอย่างของ <i> judge
```
