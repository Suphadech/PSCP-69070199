...
```text
โจทย์จะให้ทำการเช็คสลากกินแบ่งโดยที่จะกำหนดเงื่อนไขมาให้หากตรงกับเงื่อนไขที่กำหนดให้ก็ print เงินรางวัลออกมา
Input:
มี 2 บรรทัด 
ผลการออกรางวัลสลากกินแบ่ง
หมายเลขสลากที่ซื้อ

Output:
เงืนรางวัลที่มากที่สุดที่มารถได้
```
...
Step 2: รับค่า input เป็นลอตเตอรี่ที่ต้องการเช็คพร้อมกับลอตเตอรี่ที่ซื้อ
Step 3: จากนั้นเอาไปเช็คเงื่อนไขตามที่โจทก์บอกด้วย String slicing ตามลำดับ
Step 4: ปริ้นผลลัพธ์
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมใช้ if-else กับ string slicing ในการเช็คสลาก
```
