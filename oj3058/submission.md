...
ให้หาว่าเมื่อนำอิฐมาต่อกันสร้างเป็นสะพานจะต้องใช้อิฐก้อนเล็กน้อยที่สุดกี่ก้อน
Input : 
ค่า a
ค่า b
ค่า goal
...
```text
Step1:เขียน ModuleDocstring
Step2:คิดวิธีทำ
Step3:รับค่าตัวแปรมาทั้งหมด
Step4:สร้างตัวแปรหาค่าการใช้ b แล้วเอาไปหา remain ถ้า remain <= a ก็สั่งปริ้น remainที่เหลือก็คือสร้างไม่ได้
```
...
```text
คล้ายกับวิธีแรกแต่ตอนสร้างตัวแปร use_b ก็ใช้ min(b,goal//5) เพื่อไม่ให้ใช้อิฐเกินจำนวน b
```
