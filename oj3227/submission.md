...
```text
เขียนโปรแกรมเพื่อป้อนชื่อของไพ่แต่ละใบ และแปลงเป็นชื่อเต็มตามสัญลักษณ์ของไพ่ที่ได้รับ
ไพ่จะมีแต้มเป็นหมายเลข 2-10 และแต้มที่เป็นตัวอักษรได้แก่ A , J , Q , K
พร้อมกับสัญลักษณ์แบ่งออกเป็น 4 แบบ ได้แก่ D คือข้าวหลามตัด (diamonds), H คือหัวใจ (hearts), S คือโพดำ (spades) และ C คือดอกจิก (clubs)
Input:
รับแต้มของไพ่และประเภทของไพ่
แต้มเป็นได้ทั้งตัวอักษร(ได้ทั้งพิมพ์เล็ก)หรือตัวเลข
...
```text
Step 1: เขียน Docstring กัน PEP-8
Step 2: รับค่า Input เป็นชื่อไพ่แบบย่อแล้วใช้ Dictionary จัดการแยกโดยให้ 
"A": "ace",
 "J": "jack",
"K": "king",
"Q": "queen" 
และก็ทำอย่างนี้กับประเภทไพ่ด้วยเช่นกันคือ 
"D": "diamonds",
"H": "hearts",
"S": "spades",
"C": "clubs"
Step 3: หลังจากนั้นเราก็จะเอาชื่อเต็มของแต้มที่ใส่มาโดยการนำฟังก์ชั่น .get มาใช้ส่วนประเภทของไฟ่เราก็สามารถเอาไปเทียบแล้วได้ชื่อเต็มมาเลย 
Step 4: ปริ้นผลลัพธ์
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมใช้ dictionary เป็นตัวเทียบแล้วเอาฟังก์ชั่น .get มาเอาชื่อเต็มออกไปใช้
```
...
```text
ลองตาม sample testcase ใน i judge
```
