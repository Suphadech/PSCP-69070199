...
```text
โจทย์ให้หาจำนวนครั้งที่กบกระโดดน้อยที่สุดจนกว่าจะไปถึงตำแหน่งที่ตั้งไว้ให้ได้โดยแต่ละครั้งที่กบกระโดดระยะทางที่โดดได้ก็จะลดลง 2 หน่วยหากไปไม่ถึงให้ตอบ -1
Input:
จํานวนเต็ม X และ Y
X คือระยะครั้งแรกที่กระโดดได้
Y คือระยะเป้าหมายที่ต้องการไปให้ถึง
...
Step 2: รับค่า input X และ Y โดยที่ X หมายถึงระยะที่สามารถกระโดดได้ครั้งแรกและ Y คือระยะเป้าหมาย
Step 3: กำหนดตัแปร distance = 0 แล้วใช้ for-loop ไปเรื่่อยๆโดยการลูปแต่ละรอบระยะทางที่สามาถโดดได้ก็จะลดลง 2 ทุกๆลูป
Step 4: ใช้ if เช็คเงื่อนไขหาก ระยะทางที่สามาถกระโดดได้นั้นต่ำกว่า 0 และยังไม่สามาถโดดไปถึงเป้าหมายได้ก็ให้ปริ้น -1 แต่ถ้าหากสามาถ ถึงเป้าหมายได้ก็ปริ้น จำนวนครั้งในรูป
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก แต่มีการปรับเปลี่ยนโดยการใส่ break เข้าไปในลูปด้วยเพื่อให้หลุดออกจากลูปได้และไม่ต้องวนไปปริ้นใหม่
```
