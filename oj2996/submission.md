...
```text
รับ Input ข้อความตัวอักษรภาษาอังกฤษยาว 5 ตัวอักษร แล้วแสดงผลข้อความตัวอักษรภาษาอังกฤษแบบกลับด้านเป็นตัวพิมพ์เล็กทั้งหมดด้วย Slicing notation และ .lower()
```
...
Step 2: สร้างตัวแปร text เก็บค่า input เป็น string และใช้ .lower ทำให้เป็นตัวเล็ก
Step 3: print output ในรูปแบบ F-string แล้วใช้ Slicing notation ทำให้ text output กลับด้าน
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมใช้ Slicing notation ทำให้ text กลับด้านพอเอา test case ตัวอย่างจากในเว็ป <i> judge มาใส่ input แล้ว output ตรงแล้วลองใส่ testcase อื่นๆก็เป็นตามที่คาดครับ
```
...
```text
ทดสอบว่า Output นั้นเป็นการกลับด้านของ Input
```
...
```text
ทดสอบว่า Output นั้นเป็นการกลับด้านของ Input และเป็นตัวพิมพ์เล็กทั้งหมด
```
