...
```text
รับจํานวนเต็ม N แทนจํานวนครั้งของการกระทําและตามด้วยคําสั่ง N ครั้งคําสั่งมีได้ 2 แบบคือ
+ เพิ่ม 10 คะแนน
- ลด 5 คะแนน
เขียนโปรแกรมเพื่อจําลองเกมและหาคะแนนรวมหลังจากทําครบทุกคําสั่ง
...
Step2:รับค่า Input n แทนจำนวนคำสั่งที่ต้องรับสร้างตัวแปร total เอาไว้เก็บค่าคะแนนรวม
Step3:ใช้ for-loop ตามจำนวนคำสั่งจากนั้นก็รับค่าเครื่องหมายและเอาไปคิด if-else หากเป็น + ผลรวม total += 10 หากนอกเหนือจากนั้น total -= 5
Step4:ปริ้น total แล้วลอง check testcase ต่างๆ
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ใช้ for-loop ตามจำนวนคำสั่งจากนั้นก็รับค่าเครื่องหมายและเอาไปคิด if-else หากเป็น + ผลรวม total += 10 หากนอกเหนือจากนั้น total -= 5 แล้วดูผลลัพธ์
```
