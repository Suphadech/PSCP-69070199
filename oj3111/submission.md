...
```text
โจทย์นี้เป็นการคำนวณยอดรวมจากการที่ได้หักส่วนลดหรือไม่ได้ก็ตามโดยมีการเช็คว่านักเรียนเป็นสทาชิกหรือไม่หากไม่เป็นแล้วยอดที่ซื้อเกิน 500 บาทหรือไม่กรณีอื่นๆจะไม่มีการลดราคา

Input:
เช็คว่าเป็นสมาชิกหรือไม่
จำนวนของที่ซื้อ N ชื้น
ราคาของแต่ละชิ้นที่ซื้อ N อัน
...
Step2:import math เอาไว้ใช้ในการปัดเศษ
Step3:รับค่า status กับ quantity คือสถานะการเป็นสมาชิกกับจำนวนของที่ซื้อ N ชิ้น
Step4:ใช้ for-loop ในการรับค่าราคาของที่ซื้อเอาไปเพิ่มในตัวแปร total คือยอดรวมทั้งหมดก่อนลดราคา
Step5:ใช้ if เช็คว่าเป็นสมาชิกหรือไม่หากเป็นจะได้นับส่วนลด 5% แล้วใช้ elif ในการเช็คว่าหากไม่ได้เป็นสมาชิกแต่ซื้อของเกิน 500 บาทก็จะได้ส่วนลด 3% หากไม่เข้าเงื่อนไขไหนเลยก็จะไม่ได้ลด
Step6:สั่ง print ยอดราคาสุทธิทั้งหมด โดยการเอามาคำนวณทางคณิตศาสตร์ก็จะได้ผลลัพธ์ออกมา
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมใช้ if-else ในการเช็คเงื่อนไขจากนั้นก็เอามาหาราคาสุดท้ายแล้ว print output
```
...
```text
check ผลลัพธ์ให้ตรงกับ sample testcase ของ i judge
```
